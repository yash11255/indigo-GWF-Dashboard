...
let DATA_FILE = path.join(__dirname, '../../01072026_IGWF_Applicants_List.xlsx');
...
const NEEDED = [
  ...
  'FamilyAnnualIncome',
  'Familys_annual_household_income',
...
function parseRow(r) {
  ...
  const region   = pickFirst(r,'Permanent_Region','Region') || 'Not Specified';
  ...
  const rawMed   = pickFirst(r,'Have_you_undergone_DGCA_medical_assessment','Have_you_cleared_any_DGCA_exam') || '';
  ...
  const rawInc = pickFirst(r,'FamilyAnnualIncome','Familys_annual_household_income') || '';
